...
public class DefaultTrackSelector extends MappingTrackSelector {
    ...
    public static final class Parameters {
        ...
        public Parameters withoutVideoSizeConstraints() {
            return withMaxVideoSize(ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
        }
        ...
        public Parameters withoutViewportSizeConstraints() {
            return withViewportSize(ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED, true);
        }
    ...
    private static List<Integer> getViewportFilteredTrackIndices(TrackGroup group, int viewportWidth, int viewportHeight, boolean orientationMayChange) {
        ...
        if (!(viewportWidth == ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED || viewportHeight == ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED)) {
