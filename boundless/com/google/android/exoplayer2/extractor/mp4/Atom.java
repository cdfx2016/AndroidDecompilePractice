...
abstract class Atom {
    ...
    public static final int TYPE_data = Util.getIntegerCodeForString(DataPacketExtension.ELEMENT_NAME);
    ...
    public static final int TYPE_name = Util.getIntegerCodeForString(Preferences.sbry);
