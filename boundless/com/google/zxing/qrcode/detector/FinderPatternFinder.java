...
public class FinderPatternFinder {
    ...
    private boolean crossCheckDiagonal(int startI, int centerJ, int maxCount, int originalStateCountTotal) {
        ...
        int i = 0;
        while (startI - i >= 0 && this.image.get(centerJ - i, startI - i)) {
        ...
        while (startI - i >= 0 && centerJ - i >= 0 && !this.image.get(centerJ - i, startI - i) && stateCount[1] <= maxCount) {
        ...
        while (startI - i >= 0 && centerJ - i >= 0 && this.image.get(centerJ - i, startI - i) && stateCount[0] <= maxCount) {
