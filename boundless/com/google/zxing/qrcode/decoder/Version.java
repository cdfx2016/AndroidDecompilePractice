...
public final class Version {
    ...
    private static Version[] buildVersions() {
        ...
        iArr = new int[]{6, 34, 60, 86, 112, TsExtractor.TS_STREAM_TYPE_DTS};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 28, 54, 80, 106, 132, Opcodes.IFLE};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 32, 58, 84, 110, 136, Opcodes.IF_ICMPGE};
        eCBlocksArr = new ECBlocks[4];
        ...
        iArr = new int[]{6, 26, 54, 82, 110, TsExtractor.TS_STREAM_TYPE_DTS, Opcodes.IF_ACMPNE};
        eCBlocksArr = new ECBlocks[4];
