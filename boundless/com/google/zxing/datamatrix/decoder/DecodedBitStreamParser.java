...
final class DecodedBitStreamParser {
    ...
    private static final char[] C40_SHIFT2_SET_CHARS = new char[]{'!', '\"', '#', '$', '%', '&', '\'', '(', ')', '*', '+', ',', '-', FilenameUtils.EXTENSION_SEPARATOR, IOUtils.DIR_SEPARATOR_UNIX, ':', ';', '<', '=', '>', '?', '@', '[', IOUtils.DIR_SEPARATOR_WINDOWS, ']', '^', '_'};
    ...
    private static Mode decodeAsciiSegment(BitSource bits, StringBuilder result, StringBuilder resultTrailer) throws FormatException {
        ...
        do {
            ...
            } else if (oneByte == TsExtractor.TS_STREAM_TYPE_AC3) {
                ...
                if (oneByte <= 229) {
                    ...
                    if (oneByte == 232) {
                        ...
                        if (oneByte == 235) {
                            ...
                            if (oneByte == PsExtractor.VIDEO_STREAM_MASK) {
    ...
    private static int unrandomize255State(int randomizedBase256Codeword, int base256CodewordPosition) {
        int tempVariable = randomizedBase256Codeword - (((base256CodewordPosition * Opcodes.FCMPL) % 255) + 1);
