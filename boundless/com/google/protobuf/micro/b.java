...
public final class b {
    ...
    public int j() {
        ...
        int i = o & TransportMediator.KEYCODE_MEDIA_PAUSE;
        byte o2 = o();
        if (o2 >= (byte) 0) {
            return i | (o2 << 7);
        }
        i |= (o2 & TransportMediator.KEYCODE_MEDIA_PAUSE) << 7;
        o2 = o();
        if (o2 >= (byte) 0) {
            return i | (o2 << 14);
        }
        i |= (o2 & TransportMediator.KEYCODE_MEDIA_PAUSE) << 14;
        o2 = o();
        if (o2 >= (byte) 0) {
            return i | (o2 << 21);
        }
        i |= (o2 & TransportMediator.KEYCODE_MEDIA_PAUSE) << 21;
        o2 = o();
        i |= o2 << 28;
        if (o2 >= (byte) 0) {
            return i;
    ...
    public long k() {
        ...
        for (int i = 0; i < 64; i += 7) {
            byte o = o();
            j |= ((long) (o & TransportMediator.KEYCODE_MEDIA_PAUSE)) << i;
            if ((o & 128) == 0) {
                return j;
            }
        }
