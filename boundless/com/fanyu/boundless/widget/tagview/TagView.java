    ...
    private void drawTags() {
        if (this.mInitialized) {
            ...
            for (final Tag tag : this.mTags) {
                ...
                View tagLayout = this.mInflater.inflate(R.layout.item_tagview, null);
                ...
                float tagWidth = (tagView.getPaint().measureText(tag.text) + ((float) this.textPaddingLeft)) + ((float) this.textPaddingRight);
