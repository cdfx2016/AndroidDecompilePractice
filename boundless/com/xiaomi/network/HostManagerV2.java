...
public class HostManagerV2 extends HostManager {
    ...
    static String a(String str) {
        try {
            ...
            for (int i = 0; i < bytes.length; i++) {
                byte b = bytes[i];
                if ((b & PsExtractor.VIDEO_STREAM_MASK) != PsExtractor.VIDEO_STREAM_MASK) {
                    bytes[i] = (byte) (((b & 15) ^ ((byte) (((b >> 4) + length) & 15))) | (b & PsExtractor.VIDEO_STREAM_MASK));
                }
            }
    ...
    protected JSONObject a() {
        ...
        synchronized (this.mHostsMapping) {
            ...
            jSONObject.put(DataPacketExtension.ELEMENT_NAME, toJSON());
        }
        return jSONObject;
    }
    ...
    protected String getRemoteFallbackJSON(ArrayList<String> arrayList, String str, String str2) {
        ...
        arrayList4.add(new a(MessageEncoder.ATTR_TYPE, str));
        if (str.equals("wap")) {
