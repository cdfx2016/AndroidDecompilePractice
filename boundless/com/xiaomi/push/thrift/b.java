...
public class b implements Serializable, Cloneable, org.apache.thrift.a<b, a> {
    ...
    private static final org.apache.thrift.protocol.b n = new org.apache.thrift.protocol.b(MessageEncoder.ATTR_TYPE, (byte) 8, (short) 2);
    ...
    public enum a {
        CHID((short) 1, "chid"),
        TYPE((short) 2, MessageEncoder.ATTR_TYPE),
        VALUE((short) 3, "value"),
    ...
    static {
        ...
        enumMap.put(a.TYPE, new org.apache.thrift.meta_data.b(MessageEncoder.ATTR_TYPE, (byte) 1, new c((byte) 8)));
        ...
        enumMap.put(a.USER, new org.apache.thrift.meta_data.b("user", (byte) 2, new c((byte) 11)));
