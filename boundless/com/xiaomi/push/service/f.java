...
public class f extends SQLiteOpenHelper {
    private static final String[] c = new String[]{Preferences.sbry, "TEXT NOT NULL", "appId", "INTEGER NOT NULL", "package_name", "TEXT NOT NULL", "create_time", "INTEGER NOT NULL", MessageEncoder.ATTR_TYPE, "TEXT NOT NULL", "center_longtitude", "TEXT", "center_lantitude", "TEXT", "circle_radius", "REAL", "polygon_point", "TEXT", "coordinate_provider", "TEXT NOT NULL", "current_status", "TEXT NOT NULL"};
    private static final String[] d = new String[]{"message_id", "TEXT NOT NULL", "geo_id", "TEXT NOT NULL", "content", "BLOB NOT NULL", MessageEncoder.ATTR_ACTION, "INTEGER NOT NULL", "deadline", "INTEGER NOT NULL"};
    ...
    private void a(SQLiteDatabase sQLiteDatabase) {
        try {
            ...
            for (int i = 0; i < c.length - 1; i += 2) {
                ...
                stringBuilder.append(c[i]).append(Token.SEPARATOR).append(c[i + 1]);
            }
    ...
    private void b(SQLiteDatabase sQLiteDatabase) {
        try {
            ...
            for (int i = 0; i < d.length - 1; i += 2) {
                ...
                stringBuilder.append(d[i]).append(Token.SEPARATOR).append(c[i + 1]);
            }
