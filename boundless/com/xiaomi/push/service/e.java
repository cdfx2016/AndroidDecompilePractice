...
public class e {
    ...
    private synchronized com.xiaomi.xmpush.thrift.k a(Cursor cursor) {
        ...
        try {
            for (com.xiaomi.xmpush.thrift.k kVar2 : com.xiaomi.xmpush.thrift.k.values()) {
                if (TextUtils.equals(cursor.getString(cursor.getColumnIndex(MessageEncoder.ATTR_TYPE)), kVar2.name())) {
                    break;
                }
            }
            kVar2 = null;
    ...
    public synchronized long a(j jVar) {
        ...
        try {
            ...
            contentValues.put(Preferences.sbry, jVar.c());
            contentValues.put("package_name", jVar.g());
            contentValues.put("create_time", Long.valueOf(jVar.i()));
            contentValues.put(MessageEncoder.ATTR_TYPE, jVar.k().name());
            ...
            if (a != null) {
                while (a.moveToNext()) {
                    try {
                        ...
                        jVar.b(a.getString(a.getColumnIndex(Preferences.sbry)));
