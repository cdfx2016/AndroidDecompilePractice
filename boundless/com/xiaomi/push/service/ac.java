...
public class ac {
    ...
    private static RemoteViews b(Context context, ab abVar, byte[] bArr) {
        ...
        try {
            ...
            int identifier = resourcesForApplication.getIdentifier(str, TtmlNode.TAG_LAYOUT, a);
            if (identifier == 0) {
                return null;
            }
            ...
            try {
                ...
                if (jSONObject2.has(MimeTypes.BASE_TYPE_TEXT)) {
                    jSONObject = jSONObject2.getJSONObject(MimeTypes.BASE_TYPE_TEXT);
    ...
    static int c(Context context, String str) {
        return context.getSharedPreferences("pref_notify_type", 0).getInt(str, ActivityChooserViewAdapter.MAX_ACTIVITY_COUNT_UNLIMITED);
    }
