        ...
        synchronized (o.class) {
            ...
            if (!TextUtils.isEmpty(str7)) {
                ...
                if (jSONObject.getInt("code") == 0) {
                    ...
                    nVar = new n(jSONObject2.getString("userId") + "@xiaomi.com/an" + d.a(6), jSONObject2.getString(Constants.EXTRA_KEY_TOKEN), jSONObject2.getString("ssecurity"), str4, str5, str6, com.xiaomi.channel.commonutils.misc.a.c());
                    a(context, nVar);
                    a = nVar;
                } else {
