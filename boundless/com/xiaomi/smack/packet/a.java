...
public class a implements e {
    ...
    public String d() {
        ...
        if (!TextUtils.isEmpty(this.b)) {
            stringBuilder.append(Token.SEPARATOR).append("xmlns=").append("\"").append(this.b).append("\"");
        }
        if (this.c != null && this.c.length > 0) {
            for (int i = 0; i < this.c.length; i++) {
                if (!TextUtils.isEmpty(this.d[i])) {
                    stringBuilder.append(Token.SEPARATOR).append(this.c[i]).append("=\"").append(d.a(this.d[i])).append("\"");
                }
            }
        }
