...
public class d implements Serializable, Cloneable, org.apache.thrift.a<d, a> {
    ...
    private static final org.apache.thrift.protocol.b k = new org.apache.thrift.protocol.b(DataPacketExtension.ELEMENT_NAME, (byte) 11, (short) 2);
    private static final org.apache.thrift.protocol.b l = new org.apache.thrift.protocol.b(Preferences.sbry, (byte) 11, (short) 3);
    ...
    public enum a {
        ...
        DATA((short) 2, DataPacketExtension.ELEMENT_NAME),
        NAME((short) 3, Preferences.sbry),
    ...
    static {
        ...
        enumMap.put(a.DATA, new b(DataPacketExtension.ELEMENT_NAME, (byte) 2, new c((byte) 11)));
        enumMap.put(a.NAME, new b(Preferences.sbry, (byte) 2, new c((byte) 11)));
