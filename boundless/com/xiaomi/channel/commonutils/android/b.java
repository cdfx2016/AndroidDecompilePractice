            ...
            for (RunningAppProcessInfo runningAppProcessInfo : runningAppProcesses) {
                ...
                while (strArr != null && i < strArr.length) {
                    if (!arrayList.contains(strArr[i])) {
                        ...
                        if (arrayList.size() == 1) {
                            stringBuilder.append(((String) arrayList.get(0)).hashCode() % DefaultOggSeeker.MATCH_BYTE_RANGE);
                        } else {
                            stringBuilder.append("#").append(strArr[i].hashCode() % DefaultOggSeeker.MATCH_BYTE_RANGE);
                        }
                    }
                    i++;
                }
