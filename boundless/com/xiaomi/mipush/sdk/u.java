    ...
    private final void a(String str, boolean z) {
        ...
        if (a.a(this.c).b() && d.d(this.c)) {
            ...
            if (TextUtils.isEmpty(str)) {
                ...
                aeVar2.a((String) generatePacketID);
            ...
            byte[] a = aq.a(q.a(this.c, aeVar, com.xiaomi.xmpush.thrift.a.Notification, false, this.c.getPackageName(), a.a(this.c).c()));
            if (a != null) {
            ...
            obtain.arg1 = i;
            this.f.sendMessageDelayed(obtain, ExoPlayerFactory.DEFAULT_ALLOWED_VIDEO_JOINING_TIME_MS);
        }
    }
