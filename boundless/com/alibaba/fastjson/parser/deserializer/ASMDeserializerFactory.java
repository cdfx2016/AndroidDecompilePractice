...
public class ASMDeserializerFactory implements Opcodes {
    ...
    public ObjectDeserializer createJavaBeanDeserializer(ParserConfig config, JavaBeanInfo beanInfo) throws Exception {
        ...
        String classNameType = packageName.replace(FilenameUtils.EXTENSION_SEPARATOR, IOUtils.DIR_SEPARATOR_UNIX) + "/" + className;
        String classNameFull = packageName + FileUtil.FILE_EXTENSION_SEPARATOR + className;
        ...
        while (i < fieldListSize) {
            ...
            if (fieldClass == Byte.TYPE || fieldClass == Short.TYPE || fieldClass == Integer.TYPE) {
                ...
                if (itemClass == String.class) {
                    ...
                    mw.visitVarInsn(25, context.var("lexer"));
                    mw.visitMethodInsn(Opcodes.INVOKEVIRTUAL, JSONLexerBase, Constants.EXTRA_KEY_TOKEN, "()I");
                    mw.visitVarInsn(54, context.var(Constants.EXTRA_KEY_TOKEN));
                    mw.visitVarInsn(21, context.var(Constants.EXTRA_KEY_TOKEN));
        ...
        if (context.fieldInfoList.length != 0) {
            ...
            for (i = 0; i < fieldListSize; i++) {
                ...
                if (fieldClass2 == Boolean.TYPE) {
                    ...
                    mw.visitMethodInsn(Opcodes.INVOKEVIRTUAL, ASMUtils.type(String.class), MessageEncoder.ATTR_LENGTH, "()I");
                    mw.visitJumpInsn(Opcodes.IFEQ, enumNull_);
                    mw.visitVarInsn(25, context.var(fieldInfo.name + "_asm_enumName"));
                    mw.visitMethodInsn(Opcodes.INVOKESTATIC, ASMUtils.type(fieldClass2), "valueOf", "(Ljava/lang/String;)" + ASMUtils.desc(fieldClass2));
                    mw.visitVarInsn(58, context.var(fieldInfo.name + "_asm"));
            ...
            mw.visitVarInsn(25, context.var("instance"));
            mw.visitVarInsn(21, 4);
            mw.visitMethodInsn(Opcodes.INVOKEVIRTUAL, ASMUtils.type(JavaBeanDeserializer.class), "parseRest", "(L" + DefaultJSONParser + ";Ljava/lang/reflect/Type;Ljava/lang/Object;Ljava/lang/Object;I)Ljava/lang/Object;");
