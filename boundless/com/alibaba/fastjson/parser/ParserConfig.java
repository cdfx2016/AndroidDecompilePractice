...
public class ParserConfig {
    ...
    private static String[] splitItemsFormProperty(String property) {
        ...
        return property.split(Constants.ACCEPT_TIME_SEPARATOR_SP);
    }
    ...
    public ObjectDeserializer getDeserializer(Class<?> clazz, Type type) {
        ...
        String className = clazz.getName().replace('$', FilenameUtils.EXTENSION_SEPARATOR);
    ...
    public static Field getFieldFromCache(String fieldName, Map<String, Field> fieldCacheMap) {
        ...
        if (field == null) {
            return (Field) fieldCacheMap.get("m_" + fieldName);
        }
        return field;
    }
