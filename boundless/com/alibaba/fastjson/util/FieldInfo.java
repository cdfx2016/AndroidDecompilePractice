...
public class FieldInfo implements Comparable<FieldInfo> {
    ...
    public static Type getFieldType(Class<?> clazz, Type type, Type fieldType) {
        ...
        if (fieldType instanceof GenericArrayType) {
            ...
            if (fieldType instanceof ParameterizedType) {
                ...
                for (i = 0; i < arguments.length && paramType != null; i++) {
    ...
    public int compareTo(FieldInfo o) {
        ...
        if (o.fieldClass.getName().startsWith(ButterKnifeProcessor.JAVA_PREFIX) && !this.fieldClass.getName().startsWith(ButterKnifeProcessor.JAVA_PREFIX)) {
            return 1;
        }
        if (!this.fieldClass.getName().startsWith(ButterKnifeProcessor.JAVA_PREFIX) || o.fieldClass.getName().startsWith(ButterKnifeProcessor.JAVA_PREFIX)) {
