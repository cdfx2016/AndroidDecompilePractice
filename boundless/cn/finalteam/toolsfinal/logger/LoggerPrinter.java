...
public final class LoggerPrinter implements Printer {
    ...
    private void logHeaderContent(int logType, String tag, int methodCount) {
        ...
        for (int i = methodCount; i > 0; i--) {
            ...
            if (stackIndex < trace.length) {
                ...
                builder.append("║ ").append(level).append(getSimpleClassName(trace[stackIndex].getClassName())).append(FileUtil.FILE_EXTENSION_SEPARATOR).append(trace[stackIndex].getMethodName()).append(Token.SEPARATOR).append(" (").append(trace[stackIndex].getFileName()).append(":").append(trace[stackIndex].getLineNumber()).append(")");
                level = level + "   ";
    ...
    private String formatTag(String tag) {
        ...
        return this.tag + Constants.ACCEPT_TIME_SEPARATOR_SERVER + tag;
    }
