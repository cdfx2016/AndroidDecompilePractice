...
public class Base64Coder {
    static final /* synthetic */ boolean $assertionsDisabled = (!Base64Coder.class.desiredAssertionStatus());
    ...
    static class Encoder extends Coder {
        ...
        static {
            boolean z;
            if (Base64Coder.class.desiredAssertionStatus()) {
                z = false;
            } else {
                z = true;
            }
...
*/
        ...
        L_0x0247:
            ...
            goto L_0x0052;
            */
            throw new UnsupportedOperationException("Method not decompiled: cn.finalteam.toolsfinal.coder.Base64Coder.Encoder.process(byte[], int, int, boolean):boolean");
        }
    }
