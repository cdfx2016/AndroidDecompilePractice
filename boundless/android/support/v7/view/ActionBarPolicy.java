...
public class ActionBarPolicy {
    ...
    public int getMaxActionButtons() {
        ...
        if (ConfigurationHelper.getSmallestScreenWidthDp(res) > 600 || widthDp > 600 || ((widthDp > ImageUtils.SCALE_IMAGE_HEIGHT && heightDp > 720) || (widthDp > 720 && heightDp > ImageUtils.SCALE_IMAGE_HEIGHT))) {
            return 5;
        }
        if (widthDp >= 500 || ((widthDp > ImageUtils.SCALE_IMAGE_WIDTH && heightDp > 480) || (widthDp > 480 && heightDp > ImageUtils.SCALE_IMAGE_WIDTH))) {
            return 4;
        }
        if (widthDp >= 360) {
            return 3;
