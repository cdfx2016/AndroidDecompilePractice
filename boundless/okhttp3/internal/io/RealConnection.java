...
public final class RealConnection extends Listener implements Connection {
    ...
    public String toString() {
        return "Connection{" + this.route.address().url().host() + ":" + this.route.address().url().port() + ", proxy=" + this.route.proxy() + " hostAddress=" + this.route.socketAddress() + " cipherSuite=" + (this.handshake != null ? this.handshake.cipherSuite() : PrivacyRule.SUBSCRIPTION_NONE) + " protocol=" + this.protocol + '}';
    }
}
