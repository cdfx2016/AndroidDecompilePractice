...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    private final LinkedHashMap<String, Entry> lruEntries = new LinkedHashMap(0, AdaptiveVideoTrackSelection.DEFAULT_BANDWIDTH_FRACTION, true);
    ...
    private synchronized okhttp3.internal.DiskLruCache.Editor edit(java.lang.String r5, long r6) throws java.io.IOException {
        ...
        r1 = (okhttp3.internal.DiskLruCache.Entry) r1;	 Catch:{ all -> 0x003d }
        r2 = -1;
    ...
    L_0x0062:
        r1 = new okhttp3.internal.DiskLruCache$Entry;	 Catch:{ all -> 0x003d }
        r2 = 0;
        r1.<init>(r5);	 Catch:{ all -> 0x003d }
        r2 = r4.lruEntries;	 Catch:{ all -> 0x003d }
        r2.put(r5, r1);	 Catch:{ all -> 0x003d }
    L_0x006d:
        r0 = new okhttp3.internal.DiskLruCache$Editor;	 Catch:{ all -> 0x003d }
        r2 = 0;
