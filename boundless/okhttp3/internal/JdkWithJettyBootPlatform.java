...
class JdkWithJettyBootPlatform extends Platform {
    ...
    public static Platform buildIfSupported() {
        try {
            ...
            return new JdkWithJettyBootPlatform(negoClass.getMethod("put", new Class[]{SSLSocket.class, providerClass}), negoClass.getMethod("get", new Class[]{SSLSocket.class}), negoClass.getMethod(Item.REMOVE_ACTION, new Class[]{SSLSocket.class}), clientProviderClass, serverProviderClass);
