...
public class PixelBuffer {
    ...
    private void listConfig() {
        ...
        for (EGLConfig config : this.mEGLConfigs) {
            Log.i(TAG, "    <d,s,r,g,b,a> = <" + getConfigAttrib(config, 12325) + Constants.ACCEPT_TIME_SEPARATOR_SP + getConfigAttrib(config, 12326) + Constants.ACCEPT_TIME_SEPARATOR_SP + getConfigAttrib(config, 12324) + Constants.ACCEPT_TIME_SEPARATOR_SP + getConfigAttrib(config, 12323) + Constants.ACCEPT_TIME_SEPARATOR_SP + getConfigAttrib(config, 12322) + Constants.ACCEPT_TIME_SEPARATOR_SP + getConfigAttrib(config, 12321) + ">");
        }
        Log.i(TAG, "}");
    }
