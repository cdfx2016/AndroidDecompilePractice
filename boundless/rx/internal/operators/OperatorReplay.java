...
public final class OperatorReplay<T> extends ConnectableObservable<T> {
    ...
    static class BoundedReplayBuffer<T> extends AtomicReference<Node> implements ReplayBuffer<T> {
        ...
        public final void replay(rx.internal.operators.OperatorReplay.InnerProducer<T> r14) {
            ...
            r12 = 0;
            monitor-enter(r14);
            r9 = r14.emitting;	 Catch:{ all -> 0x0075 }
        ...
        L_0x0044:
            ...
            r9 = rx.internal.operators.NotificationLite.accept(r0, r5);	 Catch:{ Throwable -> 0x0054 }
        ...
        L_0x0054:
            ...
            r14.unsubscribe();
            r9 = rx.internal.operators.NotificationLite.isError(r5);
            if (r9 != 0) goto L_0x000a;
        L_0x0063:
            r9 = rx.internal.operators.NotificationLite.isCompleted(r5);
            if (r9 != 0) goto L_0x000a;
        L_0x0069:
            r9 = rx.internal.operators.NotificationLite.getValue(r5);
        ...
        L_0x0097:
            monitor-enter(r14);
            r9 = r14.missed;	 Catch:{ all -> 0x00a2 }
    ...
    static final class UnboundedReplayBuffer<T> extends ArrayList<Object> implements ReplayBuffer<T> {
        ...
        public void replay(rx.internal.operators.OperatorReplay.InnerProducer<T> r15) {
            ...
            r10 = 0;
            monitor-enter(r15);
            r11 = r15.emitting;	 Catch:{ all -> 0x0049 }
        ...
        L_0x0033:
            r6 = r14.get(r1);
            r11 = rx.internal.operators.NotificationLite.accept(r0, r6);	 Catch:{ Throwable -> 0x004e }
            if (r11 != 0) goto L_0x000a;
        L_0x003d:
            r11 = r15.isUnsubscribed();
            if (r11 != 0) goto L_0x000a;
        ...
        L_0x004e:
            ...
            r15.unsubscribe();
            r10 = rx.internal.operators.NotificationLite.isError(r6);
            if (r10 != 0) goto L_0x000a;
        L_0x005b:
            r10 = rx.internal.operators.NotificationLite.isCompleted(r6);
            if (r10 != 0) goto L_0x000a;
        L_0x0061:
            r10 = rx.internal.operators.NotificationLite.getValue(r6);
        ...
        L_0x0085:
            monitor-enter(r15);
            r11 = r15.missed;	 Catch:{ all -> 0x0090 }
